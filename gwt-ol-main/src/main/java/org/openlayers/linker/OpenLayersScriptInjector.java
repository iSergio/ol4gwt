...
public class OpenLayersScriptInjector extends AbstractLinker {
    private static String SCRIPT_LOADER = "loadOpenLayersScripts.js";
    private static String LOADED_SCRIPTS = "__gwt_openLayersScriptsLoaded";
    private static String PAGE_RELATIVE_MODULE_PATH = "openLayersScriptInjector.pageRelativeModulePath";
    ...
    public String getDescription() {
        return "OpenLayersScriptInjector";
    }
