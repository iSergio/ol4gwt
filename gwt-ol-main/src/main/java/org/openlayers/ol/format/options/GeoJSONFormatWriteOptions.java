...
public class GeoJSONFormatWriteOptions extends GeoJSONFormatReadOptions {
    /**
     ...
     * they are provided at construction. If true, the right-hand rule will be applied. If false, the left-hand rule
     * will be applied (clockwise for exterior and counter-clockwise for interior rings). Note that not all formats
     * support this. The GeoJSON format does use this property when writing geometries.
     */
    @JsProperty
    ...
    @JsConstructor
    public GeoJSONFormatWriteOptions() {}
}
