...
public class OpenLayersLinker extends AbstractLinker {
    @Override
    ...
    public ArtifactSet link(TreeLogger logger, LinkerContext context, ArtifactSet artifacts) throws UnableToCompleteException {
        ...
        for (EmittedArtifact emittedArtifact : emittedArtifacts) {
            ...
            if (partialPath.endsWith("/ol.js")) {
                String contents = OpenLayersLinkerUtils.getContents(emittedArtifact, logger);
