 ...
 */
@JsType(isNative = true, namespace = "ol.format", name = "GML3")
public class GML3Format extends GMLBaseFormat {
    @JsConstructor
    public GML3Format() {}

    @JsConstructor
    public GML3Format(GMLFormatOptions options) {}
     ...
     */
    @JsMethod
    public native Node writeGeometryNode(Geometry geometry);
     ...
     */
    @JsMethod
    public native Node writeGeometryNode(Geometry geometry, FormatWriteOptions options);
}
