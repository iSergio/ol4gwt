 ...
 */
@JsType(isNative = true, namespace = "ol.format.filter", name = "Intersects")
public class IntersectsFilter extends SpatialFilter {
     ...
     */
    @JsConstructor
    public IntersectsFilter(String geometryName, Geometry geometry) {}
     ...
     */
    @JsConstructor
    public IntersectsFilter(String geometryName, Geometry geometry, String srsName) {}
}
