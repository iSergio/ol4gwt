 ...
 */
@JsType(isNative = true, namespace = "ol.format.filter", name = "Spatial")
public class SpatialFilter extends Filter {
     ...
     */
    @JsConstructor
    public SpatialFilter(String tagName, String geometryName, String geometry) {}
     ...
     */
    @JsConstructor
    public SpatialFilter(String tagName, String geometryName, String geometry, String srsName) {}
}
