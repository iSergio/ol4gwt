...
/**
 * {@link org.openlayers.ol.interaction.DragRotateAndZoomInteraction} options.
 *
 * @author Serge Silaev aka iSergio <s.serge.b@gmail.com>
 */
@JsType(isNative = true, namespace = JsPackage.GLOBAL, name = "Object")
public class DragRotateAndZoomInteractionOptions {
    /**
    ...
    @JsConstructor
    public DragRotateAndZoomInteractionOptions() {}
}
