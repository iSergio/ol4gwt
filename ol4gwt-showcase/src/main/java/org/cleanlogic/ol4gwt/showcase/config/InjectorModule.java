 ...
 */
package org.cleanlogic.ol4gwt.showcase.config;

import com.google.gwt.inject.client.AbstractGinModule;
import com.google.gwt.user.client.ui.Image;
import org.cleanlogic.ol4gwt.showcase.config.provider.ShowcaseBrandsProvider;
import org.cleanlogic.ol4gwt.showcase.config.provider.ShowcaseLogoProvider;
import org.cleanlogic.ol4gwt.showcase.examples.*;
import org.cleanlogic.ol4gwt.showcase.puregwt.ShowcaseEventBus;
import org.cleanlogic.ol4gwt.showcase.puregwt.ShowcaseEventBusImpl;
...
public class InjectorModule extends AbstractGinModule {
    ...
    protected void configure() {
        ...
        bind(WMSTiled.class).asEagerSingleton();
    }
}
